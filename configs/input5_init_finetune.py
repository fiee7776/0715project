...
gym.register(
    id="Unitree-G1-29dof-Mimic-Input5",
...
gym.register(
    id="Unitree-G1-29dof-Mimic-Input5-Finetune",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.tracking_env_cfg:RobotEnvCfg",
        "play_env_cfg_entry_point": f"{__name__}.tracking_env_cfg:RobotPlayEnvCfg",
        "rsl_rl_cfg_entry_point": f"{__name__}.input5_finetune_ppo_cfg:Input5FineTunePPORunnerCfg",
    },
)
