...
from unitree_rl_lab.tasks.mimic.mdp.delayed_joint_action import DelayedJointPositionActionCfg
...
class ActionsCfg:
    ...
    JointPositionAction = DelayedJointPositionActionCfg(
        asset_name="robot",
        joint_names=[".*"],
...
class EventCfg:
    ...
    base_com = EventTerm(
        ...
        params={
            ...
            "com_range": {"x": (-0.01, 0.01), "y": (-0.01, 0.01), "z": (-0.015, 0.015)},
        },
    )
