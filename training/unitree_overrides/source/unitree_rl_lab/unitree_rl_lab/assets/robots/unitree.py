...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUrdfFileCfg(
        asset_path="/root/g1_description/g1_29dof_rev_1_0.urdf",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.8),
        joint_pos={
...
UNITREE_G1_29DOF_MIMIC_CFG = UnitreeArticulationCfg(
    # This server does not have the official Unitree USD package. Use the same local
    # 29DOF G1 URDF that already works for the velocity task.
    spawn=UnitreeUrdfFileCfg(
        asset_path="/root/g1_description/g1_29dof_rev_1_0.urdf",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
